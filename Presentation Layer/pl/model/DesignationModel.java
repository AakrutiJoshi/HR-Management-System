...
public Object getValueAt(int rowIndex,int columnIndex) //how pl will display the data will be based on this method
{
...
companyNamePara.add("FLY free Corporation");
...
//create footer
doc.add(dataTable);
doc.add(new Paragraph("Software By : Aakruti Joshi"));
