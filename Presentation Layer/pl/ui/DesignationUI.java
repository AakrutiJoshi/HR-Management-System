...
{
logoIcon= new ImageIcon(this.getClass().getResource("/icons/logo.png")); //mtlb ye jo class he jis class ke object k lie code chlra hai. uski designation 1 Class name k object me load kri jaegi or uss class name k object ka address return kara jaega or vo jis kisi jar me he uski baat hogi getResource() se
...
Font dataFont = new Font("Verdana",Font.BOLD,16);
...
titleLabel.setBounds(lm+110+5+5,tm+20,400,30);
...
//java -classpath ..\common\dist\hr-common.jar;..\dl\dist\hr-dl-1.0.jar;..\bl\build\libs\bl.jar;build\libs\pl.jar;libs\*;. com.thinking.machines.hr.pl.Main