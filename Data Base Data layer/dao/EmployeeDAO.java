...
preparedStatement.setInt(1,employeeDesignationCode);
...
preparedStatement.setInt(2,employeeDesignationCode);
...
try
{
//we are Presenting employee ID as A1000001 but internally employee id is 1,2,3... in Data base so we need 1,2,3....n for performing operations so this is how we will do it..
...
Connection connection=DAOConnection.getConnection();
PreparedStatement preparedStatement;
preparedStatement=connection.prepareStatement("select * from employee where panNumber=?");
preparedStatement.setString(1,panNumber);
ResultSet resultSet=preparedStatement.executeQuery();
if(resultSet.next()==false)
{
